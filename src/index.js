...
renderer.setClearColor('#47001b');

const node = document.querySelector('.can');
...
function onMouseMove(e){
  ...
  gsap.to(scene.rotation,{
    ...
    x:gsap.utils.mapRange(0,window.innerHeight,0.8,-0.8,y)
...
tl.fromTo('.can',{scale:1.3,borderRadius:"0rem"},
{
  scale:1,
  borderRadius:'2rem',
  delay:0.35,
...
tl.from('.cta-btn',{y:50,opacity:0},{y:0,opacity:1},"<");
...
(function() {
  ...
  var loop = function() {
      ...
      bufferCtx.save();
      bufferCtx.fillStyle = bufferCtx.strokeStyle = '#111';
